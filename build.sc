...
trait CalibanCodegenModule extends ScalaModule {
  ...
  /*def outputSchema = {
    millSourcePath / "src" / "SchemaGenerated.scala"
  }*/

  def outputClient = {
    millSourcePath / "src" / "ClientGenerated.scala"
  }
  ...
  def generateCode = T {
    ...
    /**runtime.unsafeRun(
      CodeGen.generate(schema.toString(), outputSchema.toString(), SchemaWriter.write)
